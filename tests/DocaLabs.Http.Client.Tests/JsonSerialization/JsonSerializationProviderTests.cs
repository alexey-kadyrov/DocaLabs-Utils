...
namespace DocaLabs.Http.Client.Tests.JsonSerialization
{
    ...
    class when_json_serialization_provider_is_used_concurrently
    {
        ...
        static Action<object, CompositionException> original_action;

        Cleanup after_each =
            () => LibraryExtensionsComposer.OnCompositionException = original_action;
        ...
        Establish context = () =>
        {
            ...
            original_action = LibraryExtensionsComposer.OnCompositionException;

            LibraryExtensionsComposer.OnCompositionException = (o, e) => { };
        };
