...
namespace DocaLabs.Storage.Core.Tests.Repositories.DataService
{
    ...
    [Subject(typeof(FindByKeysExtensions))]
    ...
    class when_searching_on_entity_and_number_of_search_keys_not_matching_number_of_defined_keys
    {
        ...
        It should_mention_entity_type_in_the_eception_message =
            () => exception.Message.ShouldContain("SampleEntity1");
    }
    ...
    class when_name_in_data_service_key_attribute_does_not_match_any_property
    {
        ...
        It should_mention_missing_property_in_the_exception_message =
            () => exception.Message.ShouldContain("UnknownPartitionKey");

        It should_mention_entity_type_in_the_exception_message =
            () => exception.Message.ShouldContain("SampleEntity6");
    }
    ...
    class when_searching_by_existing_key_on_entity_finds_more_than_one_entity
    {
        ...
        It should_throw_exception_with_expected_message =
            () => exception.Message.ShouldEqual("The get unique query returned more than one entity.");
    }
    ...
    class when_there_are_more_than_one_property_marked_with_key_attribute
    {
        ...
        It should_mention_entity_type_in_the_eception_message =
            () => exception.Message.ShouldContain("SampleEntity4");
    }
    ...
    class when_there_is_no_any_property_specified_as_key
    {
        ...
        It should_mention_entity_type_in_the_exception_message =
            () => exception.Message.ShouldContain("SampleEntity5");
    }
    ...
    class when_converter_is_set_to_other_than_default
    {
        ...
        Cleanup after_each = () => FindByKeysExtensions.Converter = null;
        ...
        {
            FindByKeysExtensions.Converter = mock_converter.Object;
