...
namespace DocaLabs.Testing.Common.Mathematics
{
    ...
    /// </summary>
    public sealed class DistributionStoreResult
    {
        /// <summary>
        ...
        /// </summary>
        public double UniformDistributionDeviationProbability { get; private set; }
        ...
        public DistributionStoreResult(int statisticalPopulation, double collisionProbability, double uniformDistributionDeviationProbability)
        {
            StatisticalPopulation = statisticalPopulation;
            CollisionProbability = collisionProbability;
            UniformDistributionDeviationProbability = uniformDistributionDeviationProbability;
        }
    }
}
