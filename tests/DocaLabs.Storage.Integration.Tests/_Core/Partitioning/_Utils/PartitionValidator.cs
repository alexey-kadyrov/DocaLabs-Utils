...
namespace DocaLabs.Storage.Integration.Tests._Core.Partitioning._Utils
{
    static class PartitionValidator
    {
        public static DatabaseConnectionString[] PartitionConnectionStrings;
        ...
        public static DatabaseConnectionString MakePartitionDbConnectionString(int partition)
        {
            return new DatabaseConnectionString(MakePartitionConnectionString(partition));
        }
