...
namespace DocaLabs.Storage.Integration.Tests._Repositories._EntityFramework._Partitioned
{
    ...
    class when_removing_an_entity
    {
        ...
        Establish context =
            () => scenario = new Removing<PartitionedScenarioProvider> { ForceLoadPrices = true };
    ...
    class when_removing_list_of_entities
    {
        ...
        Establish context =
            () => scenario = new RemovingRange<PartitionedScenarioProvider> { ForceLoadPrices = true };
