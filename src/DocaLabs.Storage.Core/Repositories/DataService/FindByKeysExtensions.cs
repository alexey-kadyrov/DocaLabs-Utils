...
{
    /// <summary>
    /// Defines methods that allow to find an entity in the IQueryable source by primary key(s).
    /// </summary>
    public static class FindByKeysExtensions
    {
        static readonly ConcurrentDictionary<Type, ParsedTypeInformation> TypeCache;
