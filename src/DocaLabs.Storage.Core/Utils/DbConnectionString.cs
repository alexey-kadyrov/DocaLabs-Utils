...
namespace DocaLabs.Storage.Core.Utils
{
    ...
    public class DbConnectionString
    {
        ...
        /// <summary>
        /// Initializes a new instance of the DbConnectionString class using specified connection string and System.Data.SqlClient as default provider.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the DbConnectionString class using specified provider and connection string.
        /// </summary>
        /// <param name="providerName">Provider name.</param>
        /// <param name="connectionString">Connection string.</param>
        public DbConnectionString(string providerName, string connectionString)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the DbConnectionString class using information specified by ConnectionStringSettings instance. 
        /// </summary>
        /// <param name="connectionSettings">ConnectionStringSettings.</param>
        public DbConnectionString(ConnectionStringSettings connectionSettings)
        {
